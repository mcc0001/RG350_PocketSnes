...
void DrawTile(uint32 Tile,
              uint32 Offset,
              uint32 StartLine,
              uint32 LineCount);

void DrawClippedTile(uint32 Tile,
                     uint32 Offset,
                     uint32 StartPixel,
                     uint32 Width,
                     uint32 StartLine,
...
void DrawTileHalfWidth(uint32 Tile,
                       uint32 Offset,
                       uint32 StartLine,
                       uint32 LineCount);

void DrawClippedTileHalfWidth(uint32 Tile,
                              uint32 Offset,
                              uint32 StartPixel,
                              uint32 Width,
                              uint32 StartLine,
...
void DrawTilex2(uint32 Tile,
                uint32 Offset,
                uint32 StartLine,
                uint32 LineCount);

void DrawClippedTilex2(uint32 Tile,
                       uint32 Offset,
                       uint32 StartPixel,
                       uint32 Width,
                       uint32 StartLine,
...
void DrawTilex2x2(uint32 Tile,
                  uint32 Offset,
                  uint32 StartLine,
                  uint32 LineCount);

void DrawClippedTilex2x2(uint32 Tile,
                         uint32 Offset,
                         uint32 StartPixel,
                         uint32 Width,
                         uint32 StartLine,
...
void DrawLargePixel(uint32 Tile,
                    uint32 Offset,
                    uint32 StartPixel,
                    uint32 Pixels,
                    uint32 StartLine,
...
void DrawLargePixelHalfWidth(uint32 Tile,
                             uint32 Offset,
                             uint32 StartPixel,
                             uint32 Pixels,
                             uint32 StartLine,
...
void DrawTile16(uint32 Tile,
                uint32 Offset,
                uint32 StartLine,
                uint32 LineCount);

void DrawClippedTile16(uint32 Tile,
                       uint32 Offset,
                       uint32 StartPixel,
                       uint32 Width,
                       uint32 StartLine,
...
void DrawTile16HalfWidth(uint32 Tile,
                         uint32 Offset,
                         uint32 StartLine,
                         uint32 LineCount);

void DrawClippedTile16HalfWidth(uint32 Tile,
                                uint32 Offset,
                                uint32 StartPixel,
                                uint32 Width,
                                uint32 StartLine,
...
void DrawTile16x2(uint32 Tile,
                  uint32 Offset,
                  uint32 StartLine,
                  uint32 LineCount);

void DrawClippedTile16x2(uint32 Tile,
                         uint32 Offset,
                         uint32 StartPixel,
                         uint32 Width,
                         uint32 StartLine,
...
void DrawTile16x2x2(uint32 Tile,
                    uint32 Offset,
                    uint32 StartLine,
                    uint32 LineCount);

void DrawClippedTile16x2x2(uint32 Tile,
                           uint32 Offset,
                           uint32 StartPixel,
                           uint32 Width,
                           uint32 StartLine,
...
void DrawLargePixel16(uint32 Tile,
                      uint32 Offset,
                      uint32 StartPixel,
                      uint32 Pixels,
                      uint32 StartLine,
...
void DrawLargePixel16HalfWidth(uint32 Tile,
                               uint32 Offset,
                               uint32 StartPixel,
                               uint32 Pixels,
                               uint32 StartLine,
...
void DrawTile16Add(uint32 Tile,
                   uint32 Offset,
                   uint32 StartLine,
                   uint32 LineCount);

void DrawClippedTile16Add(uint32 Tile,
                          uint32 Offset,
                          uint32 StartPixel,
                          uint32 Width,
                          uint32 StartLine,
...
void DrawTile16Add1_2(uint32 Tile,
                      uint32 Offset,
                      uint32 StartLine,
                      uint32 LineCount);

void DrawClippedTile16Add1_2(uint32 Tile,
                             uint32 Offset,
                             uint32 StartPixel,
                             uint32 Width,
                             uint32 StartLine,
...
void DrawTile16FixedAdd1_2(uint32 Tile,
                           uint32 Offset,
                           uint32 StartLine,
                           uint32 LineCount);

void DrawClippedTile16FixedAdd1_2(uint32 Tile,
                                  uint32 Offset,
                                  uint32 StartPixel,
                                  uint32 Width,
                                  uint32 StartLine,
...
void DrawTile16Sub(uint32 Tile,
                   uint32 Offset,
                   uint32 StartLine,
                   uint32 LineCount);

void DrawClippedTile16Sub(uint32 Tile,
                          uint32 Offset,
                          uint32 StartPixel,
                          uint32 Width,
                          uint32 StartLine,
...
void DrawTile16Sub1_2(uint32 Tile,
                      uint32 Offset,
                      uint32 StartLine,
                      uint32 LineCount);

void DrawClippedTile16Sub1_2(uint32 Tile,
                             uint32 Offset,
                             uint32 StartPixel,
                             uint32 Width,
                             uint32 StartLine,
...
void DrawTile16FixedSub1_2(uint32 Tile,
                           uint32 Offset,
                           uint32 StartLine,
                           uint32 LineCount);

void DrawClippedTile16FixedSub1_2(uint32 Tile,
                                  uint32 Offset,
                                  uint32 StartPixel,
                                  uint32 Width,
                                  uint32 StartLine,
...
void DrawLargePixel16Add(uint32 Tile,
                         uint32 Offset,
                         uint32 StartPixel,
                         uint32 Pixels,
                         uint32 StartLine,
...
void DrawLargePixel16Add1_2(uint32 Tile,
                            uint32 Offset,
                            uint32 StartPixel,
                            uint32 Pixels,
                            uint32 StartLine,
...
void DrawLargePixel16Sub(uint32 Tile,
                         uint32 Offset,
                         uint32 StartPixel,
                         uint32 Pixels,
                         uint32 StartLine,
...
void DrawLargePixel16Sub1_2(uint32 Tile,
                            uint32 Offset,
                            uint32 StartPixel,
                            uint32 Pixels,
                            uint32 StartLine,
            ...
            for (g = 0; g <= MAX_GREEN; g++) {
                ...
                for (b = 0; b <= MAX_BLUE; b++) {
                    ...
                    GFX.X2[BUILD_PIXEL2 (r, g, b) &
                           ~ALPHA_BITS_MASK] = BUILD_PIXEL2 (r2, g2, b2);
                }
            }
        }
        ...
        for (r = 0; r <= MAX_RED; r++) {
            ...
            for (g = 0; g <= MAX_GREEN; g++) {
                ...
                for (b = 0; b <= MAX_BLUE; b++) {
                    ...
                    if (b2 == 0)
                        b2 = 1;
                    GFX.ZERO_OR_X2[BUILD_PIXEL2 (r, g, b)] = BUILD_PIXEL2 (r2,
                                                                           g2,
                                                                           b2);
                    GFX.ZERO_OR_X2[BUILD_PIXEL2 (r, g, b) &
                                   ~ALPHA_BITS_MASK] = BUILD_PIXEL2 (r2, g2,
                                                                     b2);
                }
            }
        }
        ...
        for (r = 0; r <= MAX_RED; r++) {
            ...
            for (g = 0; g <= MAX_GREEN; g++) {
                ...
                for (b = 0; b <= MAX_BLUE; b++) {
                    ...
                    GFX.ZERO[BUILD_PIXEL2 (r, g, b)] = BUILD_PIXEL2 (r2, g2,
                                                                     b2);
...
void S9xEndScreenRefresh() {
            ...
            if (!Settings.SixteenBit) {
                ...
                if (!(Memory.FillRAM[0x2131] & 0x80) &&
                    ...
                    (PPU.FixedColourRed || PPU.FixedColourGreen ||
                     PPU.FixedColourBlue)) {
                    PPU.CGDATA[0] =
                            PPU.FixedColourRed | (PPU.FixedColourGreen << 5) |
    ...
    if (CPU.SRAMModified) {
        if (!CPU.AutoSaveTimer) {
            if (!(CPU.AutoSaveTimer =
                          Settings.AutoSaveDelay * Memory.ROMFramesPerSecond))
    ...
    if (!PPU.OAMPriorityRotation || !(PPU.OAMFlip & PPU.OAMAddr & 1)) {
        ...
        do {
            ...
            if (HPos > -GFX.OBJWidths[S] && HPos <= 256) {
                ...
                for (uint8 line = 0, Y = (uint8) (PPU.OBJ[S].VPos & 0xff);
                     line < Height; Y++, line++) {
                    ...
                    if (PPU.OBJ[S].VFlip) {
                        ...
                        GFX.OBJLines[Y].OBJ[LineOBJ[Y]].Line =
                                line ^ (GFX.OBJWidths[S] - 1);
                    } else {
...
static void DrawOBJS(bool8 OnMain = FALSE,
                     uint8 D = 0) {
 ...
 */
    ...
    if (!clipcount) {
        ...
        for (int clip = 0, i = 1; clip < clipcount; clip++) {
            if (GFX.pCurrentClip->Right[clip][4] <=
                GFX.pCurrentClip->Left[clip][4])
                continue;
            int j;
            for (j = 0; j < i &&
                        Windows[j].Pos < GFX.pCurrentClip->Left[clip][4]; j++);
            if (j < i && Windows[j].Pos == GFX.pCurrentClip->Left[clip][4]) {
                Windows[j].Value = TRUE;
            } else {
                // memmove required: Overlapping addresses [Neb]
                if (j < i)
                    memmove(&Windows[j + 1], &Windows[j],
                            sizeof(Windows[0]) * (i - j));
                Windows[j].Pos = GFX.pCurrentClip->Left[clip][4];
                Windows[j].Value = TRUE;
                i++;
            }
            for (j = 0; j < i &&
                        Windows[j].Pos < GFX.pCurrentClip->Right[clip][4]; j++);
    ...
    for (uint32 Y = GFX.StartY, Offset = Y * GFX.PPL;
         Y <= GFX.EndY; Y++, Offset += GFX.PPL) {
#ifdef MK_DEBUG_RTO
        bool8 Flag=0;
#endif
        int I = 0;
...
#endif
        for (int S = GFX.OBJLines[Y].OBJ[I].Sprite;
             S >= 0 && I < 32; S = GFX.OBJLines[Y].OBJ[++I].Sprite) {
            ...
            int BaseTile = (((GFX.OBJLines[Y].OBJ[I].Line << 1) +
                             (PPU.OBJ[S].Name & 0xf0)) & 0xf0) |
                           (PPU.OBJ[S].Name & 0x100) |
                           (PPU.OBJ[S].Palette << 10);
            ...
            if (X == -256) X = 256;
            for (int t = tiles, O = Offset + X * GFX.PixSize; X <= 256 && X <
                                                                          PPU.OBJ[S].HPos +
                                                                          GFX.OBJWidths[S]; TileX = (TileX +
                                                                                                     TileInc) &
                                                                                                    0x0f, X += 8, O +=
                                                                                                    8 *
                                                                                                    GFX.PixSize) {
                ...
                if (X + 8 < NextPos) {
                    ...
                    while (x < X + 8) {
                        if (WinStat)
                            (*DrawClippedTilePtr)(BaseTile | TileX, O, x - X,
                                                  NextPos - x, TileLine, 1);
                        x = NextPos;
                        for (; WinIdx < 7 &&
                               Windows[WinIdx].Pos <= x; WinIdx++);
                        if (WinIdx == 0) WinStat = FALSE;
                        else WinStat = Windows[WinIdx - 1].Value;
                        NextPos = (WinIdx < 7) ? Windows[WinIdx].Pos : 1000;
...
static void DrawBackgroundMosaic(uint32 BGMode,
                                 uint32 bg,
                                 uint8 Z1,
                                 uint8 Z2) {
    CHECK_SOUND();
    ...
    for (uint32 Y = GFX.StartY; Y <= GFX.EndY; Y += Lines) {
        ...
        for (uint32 clip = 0; clip < ClipCount; clip++) {
            ...
            for (uint32 x = Left; x < Right; x += PixWidth,
                                             s += (IPPU.HalfWidthPixels ?
                                                   PixWidth >> 1 : PixWidth) *
                                                  GFX.PixSize,
                                             HPos += PixWidth, PixWidth = (
                    PPU.Mosaic << m5)) {
                ...
                if (BG.TileSize != 8) {
                    ...
                    (*DrawLargePixelPtr)(Tile + (Quot & 1) * m5, s, HPos & 7,
                                         PixWidth,
                                         VirtAlign, Lines);
            }
        }
...
static void DrawBackgroundOffset(uint32 BGMode,
                                 uint32 bg,
                                 uint8 Z1,
                                 uint8 Z2) {
    CHECK_SOUND();
...
//		uint32 VOff = LineData [Y].BG[2].VOffset;
        ...
        for (int clip = 0; clip < clipcount; clip++) {
            ...
            while (Left < Right) {
                ...
                Left += Count;
                TotalCount += Count;
                s += (IPPU.HalfWidthPixels ? (Offset + Count) >> 1 : (Offset +
                                                                      Count)) *
                     GFX.PixSize;
                MaxCount = 8;
            }
...
static void DrawBackgroundMode5(uint32 /* BGMODE */,
                                uint32 bg,
                                uint8 Z1,
                                uint8 Z2) {
    CHECK_SOUND();
    ...
    if ((SC1 - (unsigned short *) Memory.VRAM) > 0x10000)
        SC1 = (uint16 *) &Memory.VRAM[(((uint8 *) SC1) - Memory.VRAM) %
                                      0x10000];
    ...
    for (int Y = IPPU.Interlace ? GFX.StartY << 1 : GFX.StartY;
         Y <= endy; Y += Lines) {
        ...
        for (int clip = 0; clip < clipcount; clip++) {
            ...
            uint32 s = (IPPU.HalfWidthPixels ? Left >> 1 : Left) * GFX.PixSize +
                       Y * GFX.PPL;
            ...
            Count &= 7;
            for (int C = Middle;
                 C > 0; s += (IPPU.HalfWidthPixels ? 4 : 8), Quot++, C--) {
                Tile = READ_2BYTES(t);
                GFX.Z1 = GFX.Z2 = depths[(Tile & 0x2000) >> 13];
                if (BG.TileSize == 8) {
                    if (!(Tile & H_FLIP)) {
...
static void DrawBackground(uint32 BGMode,
                           uint32 bg,
                           uint8 Z1,
                           uint8 Z2) {
#ifdef ACCUMULATE_JOYPAD
...
//		}
    ...
    if (SC1 >= (unsigned short *) (Memory.VRAM + 0x10000))
        SC1 = (uint16 *) &Memory.VRAM[((uint8 *) SC1 - &Memory.VRAM[0]) %
                                      0x10000];
    ...
    for (uint32 Y = GFX.StartY; Y <= GFX.EndY; Y += Lines) {
        ...
        for (int clip = 0; clip < clipcount; clip++) {
            ...
            int Middle = Count >> 3;
            Count &= 7;
            for (int C = Middle; C > 0; s += (IPPU.HalfWidthPixels ? 4 : 8) *
                                             GFX.PixSize, Quot++, C--) {
                Tile = READ_2BYTES(t);
                GFX.Z1 = GFX.Z2 = depths[(Tile & 0x2000) >> 13];
...
static void DrawBGMode7Background(uint8 *Screen,
                                  int bg) {
    RENDER_BACKGROUND_MODE7 (uint8, (uint8) (b & GFX.Mode7Mask))
}

static void DrawBGMode7Background16(uint8 *Screen,
                                    int bg) {
    RENDER_BACKGROUND_MODE7 (uint16, ScreenColors[b & GFX.Mode7Mask]);
}

static void DrawBGMode7Background16Add(uint8 *Screen,
                                       int bg) {
...
static void DrawBGMode7Background16Add1_2(uint8 *Screen,
                                          int bg) {
    RENDER_BACKGROUND_MODE7 (uint16, *(d + GFX.DepthDelta) ?
                                     (*(d + GFX.DepthDelta) != 1 ?
                                      COLOR_ADD1_2(
...
static void DrawBGMode7Background16Sub(uint8 *Screen,
                                       int bg) {
    RENDER_BACKGROUND_MODE7 (uint16, *(d + GFX.DepthDelta) ?
                                     (*(d + GFX.DepthDelta) != 1 ?
...
static void DrawBGMode7Background16Sub1_2(uint8 *Screen,
                                          int bg) {
    RENDER_BACKGROUND_MODE7 (uint16, *(d + GFX.DepthDelta) ?
                                     (*(d + GFX.DepthDelta) != 1 ?
                                      COLOR_SUB1_2(
...
STATIC uint32 Q_INTERPOLATE(uint32 A,
                            uint32 B,
                            uint32 C,
                            uint32 D) {
...
static void DrawBGMode7Background16_i(uint8 *Screen,
                                      int bg) {
    RENDER_BACKGROUND_MODE7_i (uint16, theColor,
                               (ScreenColors[b & GFX.Mode7Mask]));
}

static void DrawBGMode7Background16Add_i(uint8 *Screen,
                                         int bg) {
...
static void DrawBGMode7Background16Add1_2_i(uint8 *Screen,
                                            int bg) {
    RENDER_BACKGROUND_MODE7_i (uint16, *(d + GFX.DepthDelta) ?
                                       (*(d + GFX.DepthDelta) != 1 ?
...
static void DrawBGMode7Background16Sub_i(uint8 *Screen,
                                         int bg) {
    RENDER_BACKGROUND_MODE7_i (uint16, *(d + GFX.DepthDelta) ?
                                       (*(d + GFX.DepthDelta) != 1 ?
                                        COLOR_SUB(theColor,
...
static void DrawBGMode7Background16Sub1_2_i(uint8 *Screen,
                                            int bg) {
    RENDER_BACKGROUND_MODE7_i (uint16, *(d + GFX.DepthDelta) ?
                                       (*(d + GFX.DepthDelta) != 1 ?
...
static void RenderScreen(uint8 *Screen,
                         bool8 sub,
                         bool8 force_no_add,
                         uint8 D) {
    bool8 BG0;
...
//            updateWindowSize(256, 240);
        ...
        if ((PPU.BGMode == 5 || PPU.BGMode == 6) && !IPPU.DoubleWidthPixels) {
            ...
            if (Settings.SixteenBit) {
                ...
                for (register uint32 y = 0; y < starty; y++) {
                    register uint16 *p =
                            (uint16 *) (GFX.Screen + y * GFX.Pitch2) + 255;
                    register uint16 *q =
                            (uint16 *) (GFX.Screen + y * GFX.Pitch2) + 510;
    ...
    if (Settings.Transparency
        ...
        if (!PPU.ForcedBlanking && ADD_OR_SUB_ON_ANYTHING &&
            ...
            if (IPPU.Clip[0].Count[5]) {
                for (uint32 y = starty; y <= endy; y++) {
                    register uint16 *p = (uint16 *) (GFX.Screen +
                                                     y * GFX.Pitch2);
            ...
            if (SUB_OR_ADD(5)) {
                    ...
                    for (uint32 b = 0; b < Count; b++) {
                        ...
                        if (GFX.r2131 & 0x80) {
                            if (GFX.r2131 & 0x40) {
                                ...
                                uint16 back_fixed = COLOR_SUB (back,
                                                               GFX.FixedColour);
                            ...
                            register uint8 *s =
                                    GFX.SubZBuffer + y * GFX.ZPitch + Left;
                            register uint8 *e = d + Right;
                            uint16 back_fixed = COLOR_ADD(back,
                                                          GFX.FixedColour);
                            d += Left;
                            while (d < e) {
                                if (*d == 0) {
                ...
                uint32 back =
                        IPPU.ScreenColors[0] | (IPPU.ScreenColors[0] << 16);
                pClip = &IPPU.Clip[0];
