...
void (*upscale_p)(uint32_t *dst,
                  uint32_t *src,
                  int width) = upscale_256x224_to_320x240;
 ...
 *     RGB 565.
 */
void upscale_256x224_to_320x240_bilinearish(uint32_t *dst,
                                            uint32_t *src,
                                            int width) {
    ...
    for (BlockY = 0; BlockY < 14; BlockY++) {
        ...
        for (BlockX = 0; BlockX < 64; BlockX++) {
            ...
            *(BlockDst + 320 * 3 + 1) = Weight1_3(Weight1_3(_9, _10),
                                                  Weight1_3(_13, _14));
            uint16_t _15 = *(BlockSrc + 256 * 3 + 2);
            *(BlockDst + 320 * 3 + 2) = Weight1_3(Weight1_1(_10, _11),
                                                  Weight1_1(_14, _15));
            uint16_t _16 = *(BlockSrc + 256 * 3 + 3);
            *(BlockDst + 320 * 3 + 3) = Weight1_3(Weight3_1(_11, _12),
                                                  Weight3_1(_15, _16));
            ...
            *(BlockDst + 320 * 4 + 1) = Weight1_3(Weight1_3(_13, _14),
                                                  Weight1_3(_17, _18));
            uint16_t _19 = *(BlockSrc + 256 * 4 + 2);
            *(BlockDst + 320 * 4 + 2) = Weight1_3(Weight1_1(_14, _15),
                                                  Weight1_1(_18, _19));
            uint16_t _20 = *(BlockSrc + 256 * 4 + 3);
            *(BlockDst + 320 * 4 + 3) = Weight1_3(Weight3_1(_15, _16),
                                                  Weight3_1(_19, _20));
            ...
            *(BlockDst + 320 * 5 + 1) = Weight1_3(Weight1_3(_17, _18),
                                                  Weight1_3(_21, _22));
            uint16_t _23 = *(BlockSrc + 256 * 5 + 2);
            *(BlockDst + 320 * 5 + 2) = Weight1_3(Weight1_1(_18, _19),
                                                  Weight1_1(_22, _23));
            uint16_t _24 = *(BlockSrc + 256 * 5 + 3);
            *(BlockDst + 320 * 5 + 3) = Weight1_3(Weight3_1(_19, _20),
                                                  Weight3_1(_23, _24));
            ...
            *(BlockDst + 320 * 6 + 1) = Weight1_3(Weight1_3(_21, _22),
                                                  Weight1_3(_25, _26));
            uint16_t _27 = *(BlockSrc + 256 * 6 + 2);
            *(BlockDst + 320 * 6 + 2) = Weight1_3(Weight1_1(_22, _23),
                                                  Weight1_1(_26, _27));
            uint16_t _28 = *(BlockSrc + 256 * 6 + 3);
            *(BlockDst + 320 * 6 + 3) = Weight1_3(Weight3_1(_23, _24),
                                                  Weight3_1(_27, _28));
            ...
            *(BlockDst + 320 * 7 + 1) = Weight1_3(Weight1_3(_25, _26),
                                                  Weight1_3(_29, _30));
            uint16_t _31 = *(BlockSrc + 256 * 7 + 2);
            *(BlockDst + 320 * 7 + 2) = Weight1_3(Weight1_1(_26, _27),
                                                  Weight1_1(_30, _31));
            uint16_t _32 = *(BlockSrc + 256 * 7 + 3);
            *(BlockDst + 320 * 7 + 3) = Weight1_3(Weight3_1(_27, _28),
                                                  Weight3_1(_31, _32));
            ...
            *(BlockDst + 320 * 8 + 1) = Weight1_1(Weight1_3(_29, _30),
                                                  Weight1_3(_33, _34));
            uint16_t _35 = *(BlockSrc + 256 * 8 + 2);
            *(BlockDst + 320 * 8 + 2) = Weight1_1(Weight1_1(_30, _31),
                                                  Weight1_1(_34, _35));
            uint16_t _36 = *(BlockSrc + 256 * 8 + 3);
            *(BlockDst + 320 * 8 + 3) = Weight1_1(Weight3_1(_31, _32),
                                                  Weight3_1(_35, _36));
            ...
            *(BlockDst + 320 * 9 + 1) = Weight3_1(Weight1_3(_33, _34),
                                                  Weight1_3(_37, _38));
            uint16_t _39 = *(BlockSrc + 256 * 9 + 2);
            *(BlockDst + 320 * 9 + 2) = Weight3_1(Weight1_1(_34, _35),
                                                  Weight1_1(_38, _39));
            uint16_t _40 = *(BlockSrc + 256 * 9 + 3);
            *(BlockDst + 320 * 9 + 3) = Weight3_1(Weight3_1(_35, _36),
                                                  Weight3_1(_39, _40));
            ...
            *(BlockDst + 320 * 10 + 1) = Weight3_1(Weight1_3(_37, _38),
                                                   Weight1_3(_41, _42));
            uint16_t _43 = *(BlockSrc + 256 * 10 + 2);
            *(BlockDst + 320 * 10 + 2) = Weight3_1(Weight1_1(_38, _39),
                                                   Weight1_1(_42, _43));
            uint16_t _44 = *(BlockSrc + 256 * 10 + 3);
            *(BlockDst + 320 * 10 + 3) = Weight3_1(Weight3_1(_39, _40),
                                                   Weight3_1(_43, _44));
            ...
            *(BlockDst + 320 * 11 + 1) = Weight3_1(Weight1_3(_41, _42),
                                                   Weight1_3(_45, _46));
            uint16_t _47 = *(BlockSrc + 256 * 11 + 2);
            *(BlockDst + 320 * 11 + 2) = Weight3_1(Weight1_1(_42, _43),
                                                   Weight1_1(_46, _47));
            uint16_t _48 = *(BlockSrc + 256 * 11 + 3);
            *(BlockDst + 320 * 11 + 3) = Weight3_1(Weight3_1(_43, _44),
                                                   Weight3_1(_47, _48));
            ...
            *(BlockDst + 320 * 12 + 1) = Weight3_1(Weight1_3(_45, _46),
                                                   Weight1_3(_49, _50));
            uint16_t _51 = *(BlockSrc + 256 * 12 + 2);
            *(BlockDst + 320 * 12 + 2) = Weight3_1(Weight1_1(_46, _47),
                                                   Weight1_1(_50, _51));
            uint16_t _52 = *(BlockSrc + 256 * 12 + 3);
            *(BlockDst + 320 * 12 + 3) = Weight3_1(Weight3_1(_47, _48),
                                                   Weight3_1(_51, _52));
            ...
            *(BlockDst + 320 * 13 + 1) = Weight3_1(Weight1_3(_49, _50),
                                                   Weight1_3(_53, _54));
            uint16_t _55 = *(BlockSrc + 256 * 13 + 2);
            *(BlockDst + 320 * 13 + 2) = Weight3_1(Weight1_1(_50, _51),
                                                   Weight1_1(_54, _55));
            uint16_t _56 = *(BlockSrc + 256 * 13 + 3);
            *(BlockDst + 320 * 13 + 3) = Weight3_1(Weight3_1(_51, _52),
                                                   Weight3_1(_55, _56));
...
void upscale_256x240_to_320x240_bilinearish(uint32_t *dst,
                                            uint32_t *src,
                                            int width) {
    uint16_t *Src16 = (uint16_t *) src;
    uint16_t *Dst16 = (uint16_t *) dst;
...
void upscale_256x224_to_384x240_for_400x240(uint32_t *dst,
                                            uint32_t *src,
                                            int width) {
    int midh = 240 / 2;
    int Eh = 0;
...
void upscale_256x224_to_384x272_for_480x272(uint32_t *dst,
                                            uint32_t *src,
                                            int width) {
    int midh = 272 / 2;
    int Eh = 0;
